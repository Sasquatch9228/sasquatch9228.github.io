...
if (location.search.startsWith("?detail")) {
    ...
    if (localStorage.getItem("welcome") == undefined) {
        message("<div class='logo'><image height='64px' src='assets/icon.png'></image><div>EXTENSION-REMOVER</div></div><p>EXTENSION-REMOVER contains a collection of exploits discovered by various users to expand the capability of managed Chromebooks, making it easy to find the information you need.<p>Exploit details, source code, and styles have been modified for a better user experience.<p><u><b>Disclaimers:</b> This service is not designed to encourage time wasting. Use these exploits only in your free time, and do not let them lead you to distraction. Property of your own organization should always be returned in its proper condition.</u><button class='continue'>Continue</button>");
    } else {
